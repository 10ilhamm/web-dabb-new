    ...
    <div class="space-y-6">
        ...
        <form action="{{ route('cms.pengguna.roles.update', $role) }}" method="POST"
            ...
            <div class="px-6 py-5 border-b border-gray-100">
                <h2 class="text-base font-semibold text-gray-800">{{ $role->label }}</h2>
            </div>
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    <label
                        class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('cms.roles.form_table_name') }}</label>
                    <input type="text" name="table_name" value="{{ old('table_name', $role->table_name) }}"
                ...
                <div>
                    <label
                        class="block text-sm font-medium text-gray-700 mb-1.5">{{ __('cms.roles.form_relation_name') }}</label>
