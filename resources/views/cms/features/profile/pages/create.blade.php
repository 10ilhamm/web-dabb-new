...
@push('styles')
    ...
    <style>
        ...
        #preview-container.profile-section-desc ul { list-style-type: disc !important; padding-left: 1.5rem !important; margin-bottom: 1rem !important; }
        #preview-container.profile-section-desc ol { list-style-type: decimal !important; padding-left: 1.5rem !important; margin-bottom: 1rem !important; }
        #preview-container.profile-section-desc li { margin-bottom: 0.5rem !important; display: list-item !important; }
        ...
        #preview-container.profile-section-desc h1,
        #preview-container.profile-section-desc h2,
        #preview-container.profile-section-desc h3,
        #preview-container.profile-section-desc h4,
        #preview-container.profile-section-desc h5,
        #preview-container.profile-section-desc h6 { font-weight: bold !important; margin-bottom: 0.75rem !important; color: #1e293b !important; }
        #preview-container.profile-section-desc table { border-collapse: collapse !important; margin: 1rem 0 !important; width: 100% !important; }
        ...
        #preview-container.profile-section-desc img { max-width: 100% !important; height: auto !important; margin: 1rem 0 !important; }
...
<div class="px-4 py-6 max-w-5xl mx-auto sm:px-6 lg:px-8" x-data="profilePageForm()">
    ...
    {{-- Flash --}}
    @if(session('success'))
        <div class="mb-4 bg-green-50 border border-green-200 text-green-700 px-5 py-3 rounded-xl text-sm flex items-center gap-2">
            ...
            <form action="{{ route('cms.features.profile.pages.store', [$feature, $sub]) }}" method="POST"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="url" name="link_url" x-model="linkUrl"
                                placeholder="https://..."
                                class="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6"
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Pilih field data untuk menambahkan grafik. Anda dapat menambahkan beberapa field.</p>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6"
                     x-show="pageType === 'struktur_image'"
                     x-transition>
                    <h3 class="text-sm font-semibold text-gray-700 mb-4">Logo / Gambar</h3>
                    <div id="logo-upload-area" class="image-upload-box" onclick="document.getElementById('logo_input').click()">
                        <input type="file" name="logo" id="logo_input" accept="image/png,image/webp" class="hidden" onchange="previewLogo(this)">
                    ...
                    <div id="logo_preview" class="hidden image-upload-box mt-3">
                        ...
                        <button type="button" onclick="removeLogo()" class="mt-2 text-xs text-red-500 hover:text-red-700">Hapus Logo</button>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="relative mt-3">
                        ...
                        <div class="w-full px-4 py-4 border-2 border-dashed border-gray-200 rounded-lg text-center bg-gray-50 hover:bg-gray-100 hover:border-blue-400 transition-all group cursor-pointer">
                            <svg class="w-6 h-6 mx-auto text-gray-400 group-hover:text-blue-500 transition-colors mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <input type="number" name="order" min="0" value="{{ ($pages->count() ?? 0) + 1 }}" required
                        class="w-32 px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <p class="mt-1 text-xs text-gray-400">Halaman dengan urutan lebih kecil akan ditampilkan lebih dulu</p>
                </div>
    ...
    <div class="bg-blue-50 border border-blue-100 rounded-xl p-5 mt-6">
        <div class="flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-sm text-blue-600 mt-1">Setelah halaman disimpan, Anda dapat mengelola section (sub-konten) melalui halaman Edit.</p>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('[RTE] DOMContentLoaded fired, initProfileCreateForm exists:', typeof initProfileCreateForm !== 'undefined');
